...
?>
<?php
class MagenThemes_Mtslideshow_Helper_Image extends Mage_Core_Helper_Abstract
{
    protected $_model;
    ...
    {
        $this->_reset();
        $this->_setModel(Mage::getModel('mtslideshow/mtslideshow_image'));
     ...
     *
     * @see MagenThemes_Mtslideshow_Model_Mtslideshow_Image
     * @param int $width
     * @param int $height
     * @return MagenThemes_Mtslideshow_Helper_Image
     */
    public function resize($width, $height = null)
    {
        $this->setQuality(Mage::getStoreConfig('mtslideshow/mtslideshow_config/quality'));
    ...
    public function __toString()
    {
        try {
            if( $this->getImageFile() ) {
                ...
                $this->_getModel()->setBaseFile( $this->getMtslideshow()->getData($this->_getModel()->getDestinationSubdir()) );
            }
     ...
     * Enter description here...
     *
     * @return MagenThemes_Mtslideshow_Model_Mtslideshow_Image
     */
    ...
    protected function setSlideshow($mtslideshow)
    {
        $this->_mtslideshow = $mtslideshow;
        return $this;
    }

    protected function getSlideshow()
    {
        return $this->_mtslideshow;
    }
