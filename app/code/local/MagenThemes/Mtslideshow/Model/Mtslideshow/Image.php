...
?>
<?php
class MagenThemes_Mtslideshow_Model_Mtslideshow_Image extends Mage_Core_Model_Abstract
{
    protected $_width;
    protected $_height;
    ...
    {
        $this->_init('mtslideshow/mtslideshow_image');
    }
    ...
    public function setBaseFile($file)
    {
        ...
        $baseDir = Mage::getSingleton('mtslideshow/config')->getBaseMediaPath();
    ...
    public function clearCache()
    {
        ...
        $directory = Mage::getSingleton('mtslideshow/config')->getBaseMediaPath() .DS.'cache'.DS;
